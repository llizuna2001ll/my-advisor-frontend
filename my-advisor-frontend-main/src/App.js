...
import Reported from "./admin/components/reported/Reported";
import ListReported from "./admin/components/ListReported/ListReported";
        ...
        <>
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="/singleHotel/:username" element={<SingleHotel/>}/>
                    <Route path="/reported" element={<ListReported/>}/>

                    <Route path="/SingleRestaurant/:name" element={<SingleRestaurant/>}/>
                    <Route path="/SingleOthers/:username" element={<SingleOthers/>}/>

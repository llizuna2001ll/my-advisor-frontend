    ...
    return (
        <TableContainer component={Paper} className="table">
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                <TableHead>
                    <TableRow>
                        <TableCell align="right" className="tablecell">Users</TableCell>
                        <TableCell align="right" className="tablecell">Posts</TableCell>
                        <TableCell align="right" className="tablecell">Businesses</TableCell>
                        <TableCell align="right" className="tablecell">Cities</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {rows.map((row) => (
